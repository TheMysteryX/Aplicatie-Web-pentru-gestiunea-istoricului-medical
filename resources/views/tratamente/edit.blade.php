...
<div class="middle">
    ...
    @endif  
    <div class="card">
    <form method="POST" action="{{ route('tratamente.update', $tratament->id) }}"onsubmit="return validForm();">
        @csrf
        @method('PUT')
            <label>Numele tratamentului:</label><p></p>
            <input type="text" name="nume" id="nume" class="form-input" value="{{ $tratament->nume }}"><p></p>
            <p></p>
            ...
            <input type="date" name="data_sfarsit" id="data_sfarsit" class="form-input" value="{{ $tratament->data_sfarsit }}"><p></p>
            <p></p>
            <label for="instructiuni">Instructiuni</label><p></p>
            <textarea name="instructiuni" id="instructiuni" class="form-input" {{ old('instructiuni', $tratament->instructiuni) }}></textarea><p></p>
            <p></p>
